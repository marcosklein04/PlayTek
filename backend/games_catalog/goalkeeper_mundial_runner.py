...
@require_GET
def super_portero_mundial_runner_page(request):
    ...
    try:
        session = GameSession.objects.get(id=session_id, user_id=int(user_id), game__slug="super-portero-mundial")
    ...
    return render(request, "runner/super_portero_mundial/index.html")
