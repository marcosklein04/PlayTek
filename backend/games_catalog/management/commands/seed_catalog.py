...
CATALOGO = [
    ...
    {
        "slug": "puzzle-mundial",
        "nombre": "Puzzle Mundial",
        "descripcion": "Armá la imagen del mundial intercambiando piezas hasta completar la jugada.",
        "imagen_portada_url": "",
        ...
        "destacado": False,
        "habilitado": True,
        "tags": ["web based", "interactive", "sports"],
    },
    {
        "slug": "super-portero-mundial",
        "nombre": "Súper Portero",
        "descripcion": "Mové al arquero y atajá la mayor cantidad de remates antes de que termine el reloj.",
        "imagen_portada_url": "",
    ...
    "slug": "trivia",
    "nombre": "Trivia",
    "descripcion": "Preguntas de cultura general con puntaje.",
    "imagen_portada_url": "",
